...
1   2021-Spring-Computer-Networking-Project:
    ...
    1.1   chat_app:
        ...
        1.1.1   static:
            ...
            1.1.1.2   lib:
                1.1.1.2.1   jquery.min.js
                1.1.1.2.2   moment.js
                1.1.1.2.3   socket.io.min.js

            1.1.1.3   clickInteraction.js
            1.1.1.4   displayMessage.js
            1.1.1.5   exit-icon.png
            1.1.1.6   gallery.png
            1.1.1.7   happy.png
            1.1.1.8   main.js
            1.1.1.9   style.css
        ...
        1.1.4   check_db.py
        1.1.5   groups.json
        1.1.6   system_database.db

    1.2   .gitignore (to ignore the venv when commiting to the github)
    1.3   HOWTO.txt
    1.4   makefile
    1.5   README.txt
